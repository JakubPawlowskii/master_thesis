...
As argued in the previous section, nearly integrable quantum systems constitute an important generalization
of ordinary integrable systems, facilitating experimental realizations. They form the broader context this
...
in order to avoid the limitations originating from exponential growth of many-body Hilbert spaces.
...
To end Chapter~\ref{chap:krylov}, we outline the recent concept of Quantum Typicality~\autocite{Bartsch2009}
...
occurred, allowing for unprecedented controll over the interactions.
...
yet their dynamical properties are still largely unknown, which motivates our interest in long range anisotropic
